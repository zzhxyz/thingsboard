...
export default function addLocaleChinese(locales) {
    var zh_CN = {
        ...
        "alias": {
            ...
            "filter-type-asset-type": "监测项类型",
            "filter-type-asset-type-description": "类型为 '{{assetType}}' 的监测项",
            "filter-type-asset-type-and-name-description": "类型为 '{{assetType}}' 且以 '{{prefix}}' 开头的监测项",
            "filter-type-device-type": "传感器类型",
            "filter-type-device-type-description": "类型为 '{{deviceType}}' 的传感器",
            "filter-type-device-type-and-name-description": "类型为 '{{deviceType}}' 且以 '{{prefix}}' 开头的传感器",
            ...
            "filter-type-asset-search-query": "监测项搜索查询",
            "filter-type-asset-search-query-description": "类型为 {{assetTypes}} 且具有 {{relationType}} 关联 {{direction}} {{rootEntity}} 的监测项",
            "filter-type-device-search-query": "传感器搜索查询",
            "filter-type-device-search-query-description": "类型为 {{deviceTypes}} 且具有 {{relationType}} 关联 {{direction}} {{rootEntity}} 的传感器",
            "entity-filter": "实体过滤",
        ...
        "asset": {
            ...
            "assign-asset-to-customer": "将监测项分配给客户",
            "assign-asset-to-customer-text": "请选择要分配给客户的监测项",
            "no-assets-text": "未找到监测项",
            "assign-to-customer-text": "请选择客户以分配监测项",
            "public": "公开",
            "assignedToCustomer": "分配客户",
            "make-public": "监测项设为公开",
            "make-private": "监测项设为私有",
            "unassign-from-customer": "取消分配客户",
            "delete": "删除监测项",
            "asset-public": "监测项公开",
            "asset-type": "监测项类型",
            "asset-type-required": "监测项类型必填。",
            "select-asset-type": "选择监测项类型",
            "enter-asset-type": "输入监测项类型",
            "any-asset": "Any asset",
            "no-asset-types-matching": "没有找到匹配 '{{entitySubtype}}' 的监测项类型。",
            "asset-type-list-empty": "监测项类型未选择。",
            "asset-types": "监测项类型",
            "name": "名称",
            "name-required": "名称必填。",
            "description": "描述",
            ...
            "details": "详情",
            "events": "事件",
            "add-asset-text": "添加新监测项",
            "asset-details": "监测项详情",
            "assign-assets": "分配监测项",
            "assign-assets-text": "分配 { count, select, 1 {1 监测项} other {# 监测项} } 给客户",
            "delete-assets": "删除监测项",
            "unassign-assets": "取消分配监测项",
            "unassign-assets-action-title": "从客户处取消分配 { count, select, 1 {1 监测项} other {# 监测项} } ",
            "assign-new-asset": "分配新监测项",
            "delete-asset-title": "确定要删除监测项 '{{assetName}}'?",
            "delete-asset-text": "小心！确认后监测项及其所有相关数据将不可恢复。",
            "delete-assets-title": "确定要删除 { count, select, 1 {1 监测项} other {# 监测项} }?",
            "delete-assets-action-title": "删除 { count, select, 1 {1 监测项} other {# 监测项} }",
            "delete-assets-text": "小心！确认后，所有选定的客户将被删除，所有相关数据将不可恢复。",
            "make-public-asset-title": "确定要将监测项 '{{assetName}}' 设为公开?",
            "make-public-asset-text": "确认后监测项及所有相关数据会被设为公开并对其他人所见。",
            "make-private-asset-title": "确定要将监测项 '{{assetName}}' 设为私有?",
            "make-private-asset-text": "确认后监测项及所有相关数据会被设为私有并对其他人不可见。",
            "unassign-asset-title": "确定要取消分配监测项 '{{assetName}}'?",
            "unassign-asset-text": "确定后监测项将被取消分配并对客户不可见。",
            "unassign-asset": "取消分配监测项",
            "unassign-assets-title": "确定要取消分配 { count, select, 1 {1 监测项} other {# 监测项} }?",
            "unassign-assets-text": "确定后监测项将被取消分配并对客户不可见。",
            "copyId": "复制监测项ID",
            "idCopiedMessage": "监测项ID已经复制到粘贴板",
            "select-asset": "选择监测项",
            "no-assets-matching": "没有找到匹配 '{{entity}}' 的监测项。",
            "asset-required": "监测项必填",
            "name-starts-with": "监测项名称以此开头"
        },
        "attribute": {
            "attributes": "属性",
            "latest-telemetry": "最新遥测",
            "attributes-scope": "传感器属性范围",
        ...
        "customer": {
            ...
            "public-devices": "公共传感器",
            "public-assets": "公共监测项",
            "add": "添加客户",
            "delete": "删除客户",
            "manage-customer-users": "管理客户用户",
            "manage-customer-devices": "管理客户传感器",
            "manage-customer-dashboards": "管理客户仪表板",
            "manage-public-devices": "管理公共传感器",
            "manage-public-dashboards": "管理公共仪表板",
            "manage-customer-assets": "管理客户监测项",
            "manage-public-assets": "管理公共监测项",
        ...
        "dashboard": {
            ...
            "public-dashboard-notice": "<b>提示：</b> 不要忘记将相关传感器公开以访问其数据。",
            ...
            "invalid-aliases-config": "无法找到与某些别名过滤器匹配的任何传感器。<br/>请联系您的管理员以解决此问题。",
            "select-devices": "选择传感器",
        ...
        "datakey": {
            ...
            "attributes": "属性",
            "alarm": "Alarm fields",
            "timeseries-required": "需要传感器时间序列。",
            "timeseries-or-attributes-required": "传感器时间/属性必填。",
        ...
        "device": {
            ...
            "duplicate-alias-error": "找到重复别名 '{{alias}}'。 <br> 传感器别名必须是唯一的。",
            "configure-alias": "配置 '{{alias}}' 别名",
            "no-devices-matching": "找不到与 '{{entity}}' 匹配的传感器。",
            "alias": "别名",
            "alias-required": "需要传感器别名。",
            "remove-alias": "删除传感器别名",
            "add-alias": "添加传感器别名",
            "name-starts-with": "名称前缀",
            "device-list": "传感器列表",
            "use-device-name-filter": "使用过滤器",
            "device-list-empty": "没有被选中的传感器",
            "device-name-filter-required": "传感器名称过滤器必填。",
            "device-name-filter-no-device-matched": "找不到以'{{device}}' 开头的传感器。",
            "add": "添加传感器",
            "assign-to-customer": "分配给客户",
            "assign-device-to-customer": "将传感器分配给客户",
            "assign-device-to-customer-text": "请选择要分配给客户的传感器",
            "make-public": "公开",
            "make-private": "私有",
            "no-devices-text": "找不到传感器",
            "assign-to-customer-text": "请选择客户分配传感器",
            "device-details": "传感器详细信息",
            "add-device-text": "添加新传感器",
            "credentials": "凭据",
            "manage-credentials": "管理凭据",
            "delete": "删除传感器",
            "assign-devices": "分配传感器",
            "assign-devices-text": "将{count,select,1 {1 传感器} other {# 传感器}}分配给客户",
            "delete-devices": "删除传感器",
            "unassign-from-customer": "取消分配客户",
            "unassign-devices": "取消分配传感器",
            "unassign-devices-action-title": "从客户处取消分配{count,select,1 {1 传感器} other {# 传感器}}",
            "assign-new-device": "分配新传感器",
            "make-public-device-title": "您确定要将传感器 '{{deviceName}}' 设为公开吗？",
            "make-public-device-text": "确认后，传感器及其所有数据将被设为公开并可被其他人访问。",
            "make-private-device-title": "您确定要将传感器 '{{deviceName}}' 设为私有吗？",
            "make-private-device-text": "确认后，传感器及其所有数据将被设为私有，不被其他人访问。",
            "view-credentials": "查看凭据",
            "delete-device-title": "您确定要删除传感器的{{deviceName}}吗？",
            "delete-device-text": "小心！确认后传感器及其所有相关数据将不可恢复。",
            "delete-devices-title": "您确定要删除{count,select,1 {1 传感器} other {# 传感器}} 吗？",
            "delete-devices-action-title": "删除 {count,select,1 {1 传感器} other {# 传感器}}",
            "delete-devices-text": "小心！确认后所有选定的传感器将被删除,所有相关数据将不可恢复。",
            "unassign-device-title": "您确定要取消分配传感器 '{{deviceName}}'？",
            "unassign-device-text": "确认后,传感器将被取消分配,客户将无法访问。",
            "unassign-device": "取消分配传感器",
            "unassign-devices-title": "您确定要取消分配{count,select,1 {1 传感器} other {# 传感器}} 吗？",
            "unassign-devices-text": "确认后,所有选定的传感器将被取消分配,并且客户将无法访问。",
            "device-credentials": "传感器凭据",
            ...
            "device-type": "传感器类型",
            "device-type-required": "传感器类型必填。",
            "select-device-type": "选择传感器类型",
            "enter-device-type": "输入传感器类型",
            "any-device": "任意传感器",
            "no-device-types-matching": "没有找到符合 '{{entitySubtype}}' 的传感器类型。",
            "device-type-list-empty": "未选择传感器类型",
            "device-types": "传感器类型",
            "name": "名称",
            "name-required": "名称必填。",
            "description": "说明",
            ...
            "idCopiedMessage": "传感器ID已复制到剪贴板",
            "accessTokenCopiedMessage": "传感器访问令牌已复制到剪贴板",
            "assignedToCustomer": "分配给客户",
            "unable-delete-device-alias-title": "无法删除传感器别名",
            "unable-delete-device-alias-text": "传感器别名 '{{deviceAlias}}' 不能够被删除，因为它被下列部件所使用: <br/> {{widgetsList}}",
            "is-gateway": "是网关",
            "public": "公开",
            "device-public": "传感器公开",
            "select-device": "选择传感器"
        ...
        "entity": {
            ...
            "type-device": "传感器",
            "type-devices": "传感器",
            "list-of-devices": "{ count, select, 1 {传感器} other {# 传感器列表} }",
            "device-name-starts-with": "以 '{{prefix}}' 开头的传感器",
            "type-asset": "监测项",
            "type-assets": "监测项",
            "list-of-assets": "{ count, select, 1 {监测项} other {# 监测项列表} }",
            "asset-name-starts-with": "以 '{{prefix}}' 开头的监测项",
            "type-rule": "规则",
            "type-rules": "规则",
